          ...
          <div className="row align-items-center">
            <div className="col-sm-12 col-lg-5 text-center text-lg-start">
              ...
              <h2 className="about_title">
                Welcome to Human Security Empowering Human, Ensuring Safety
              </h2>
              <p className="about_text " style={{ textAlign: "justify" }}>
                At Human Security, we are dedicated to creating a safer world for
                Human. Our journey began with a simple yet powerful idea - to
                provide Human with a tool that empowers them to feel secure and
                confident in any situation. We understand the unique challenges
                that Human face, and we are committed to using technology to
          ...
          <div className="container">
            <div className="row align-items-center">
              ...
              <div className="col-sm-12 col-lg-6 text-center text-lg-start">
                ...
                <h2 className="about_title">Why Human Security?</h2>
                <p className="about_text" style={{ textAlign: "justify" }}>
